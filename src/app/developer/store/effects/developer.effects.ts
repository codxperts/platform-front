...
import { InviteToFriend, DeveloperActionTypes, InviteToFriendSuccess, InviteToFriendFailure } from '../actions/developer.actions';
...
export class DeveloperEffects {
  ...
  .switchMap(payload => {
    console.log('eff');
      return this.developerService.InviteToFriend(payload.email, payload.user)
      .map((response) => {
