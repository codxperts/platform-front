...
import { DynamicSidenavComponent } from './components/dynamic-sidenav/dynamic-sidenav.component';

// Directives.
import { PortalScrollTopDirective } from './directives/portal-scroll-top.directive';
import { CustomerHorizontalMenuComponent } from './components/customer-horizontal-menu/customer-horizontal-menu.component';
import { DeveloperLayoutComponent } from './developer-layout/developer-layout.component';
import { DeveloperHorizontalMenuComponent } from './components/developer-horizontal-menu/developer-horizontal-menu.component';
...
@NgModule({
  ...
  declarations: [
    ...
    CustomerHorizontalMenuComponent,
    DeveloperLayoutComponent,
    DeveloperHorizontalMenuComponent
  ],
  providers: [
    LayoutService
  ]
